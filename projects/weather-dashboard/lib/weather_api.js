...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetchWeatherData_weather('pakistan'); // chart function call
    getWeeklyWeatherForecast('rawalpindi'); // default city/Country for weekly forecast
...
// Live Charts
async function fetchWeatherData_weather(c) {
